...
Define Storyblok rich-text support for rendering fixed base-currency price values with active storefront currency conversion while preserving existing directive behavior and SSR hydration safety.
