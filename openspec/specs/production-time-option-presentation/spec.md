# production-time-option-presentation Specification

## Purpose
TBD - created by archiving change i-36870-refine-production-time-option-display. Update Purpose after archive.
## Requirements
