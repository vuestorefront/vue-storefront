...
- Serialize Cart synchronization requests and wait for the active synchronization queue before evaluating a browser or URL coupon request.
...
- A serialized Cart synchronization queue and wait action backed by the active synchronization promise.
