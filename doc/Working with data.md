...
The convention is, that schemas are stored under `/src/models` - for example [Order schema](https://github.com/DivanteLtd/vue-storefront/blob/master/core/models/order_schema.json).
...
Here you have a validation schema for order: https://github.com/DivanteLtd/vue-storefront/blob/master/core/models/order_schema.json
