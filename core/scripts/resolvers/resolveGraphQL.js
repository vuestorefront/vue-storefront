...
export const getApolloProvider = async () => {
  if (server.api === 'graphql') {
    const ApolloModule = await import(
      /* webpackChunkName: "vsf-graphql" */ 'vue-apollo'
    );
    ...
    const HttpLinkModule = await import(
      /* webpackChunkName: "vsf-graphql" */ 'apollo-link-http'
    );
    ...
    const ApolloClientModule = await import(
      /* webpackChunkName: "vsf-graphql" */ 'apollo-client'
    );
