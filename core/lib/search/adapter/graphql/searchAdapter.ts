...
import {
  processESResponseType,
  processProductsType,
  processCmsType
} from './processor/processType';
...
export class SearchAdapter {
  ...
  public search(Request) {
    ...
    const storeView =
      Request.store === null
        ? currentStoreView()
        : prepareStoreView(Request.store);
    if (
      storeView.storeCode === undefined ||
      storeView.storeCode == null ||
      !Request.type
    ) {
      throw new Error(
    ...
    if (this.entities[Request.type].url) {
      ...
      urlGql =
        rootStore.state.config.server.protocol +
        '://' +
        rootStore.state.config.graphql.host +
        ':' +
        rootStore.state.config.graphql.port +
        '/graphql';
      const urlStoreCode =
        storeView.storeCode !== ''
          ? encodeURIComponent(storeView.storeCode) + '/'
          : '';
  ...
  public initBaseTypes() {
      ...
      resultPorcessor: (resp, start, size) => {
        ...
        if (resp.hasOwnProperty('data')) {
          ...
          if (resp.error) {
            ...
            throw new Error(
              "Unknown error with graphQl result in resultPorcessor for entity type 'product'"
            );
          }
        }
      }
    ...
    this.registerEntityType('attribute', {
      ...
      resultPorcessor: (resp, start, size) => {
        ...
        if (resp.hasOwnProperty('data')) {
          return processESResponseType(
            resp.data.customAttributeMetadata,
            start,
            size
          );
        } else {
          if (resp.error) {
            ...
            throw new Error(
              "Unknown error with graphQl result in resultPorcessor for entity type 'attribute'"
            );
          }
        }
      }
      ...
      resultPorcessor: (resp, start, size) => {
        ...
        if (resp.hasOwnProperty('data')) {
          ...
          if (resp.error) {
            ...
            throw new Error(
              "Unknown error with graphQl result in resultPorcessor for entity type 'review'"
            );
          }
        }
      }
      ...
      resultPorcessor: (resp, start, size) => {
        ...
        if (resp.hasOwnProperty('data')) {
          ...
          if (resp.error) {
            ...
            throw new Error(
              "Unknown error with graphQl result in resultPorcessor for entity type 'taxrule'"
            );
          }
        }
      }
      ...
      resultPorcessor: (resp, start, size) => {
        ...
        if (resp.hasOwnProperty('data')) {
          ...
          if (resp.error) {
            ...
            throw new Error(
              "Unknown error with graphQl result in resultPorcessor for entity type 'cmsPage'"
            );
          }
        }
      }
      ...
      resultPorcessor: (resp, start, size) => {
        ...
        if (resp.hasOwnProperty('data')) {
          ...
          if (resp.error) {
            ...
            throw new Error(
              "Unknown error with graphQl result in resultPorcessor for entity type 'cmsBlock'"
            );
          }
        }
      }
      ...
      resultPorcessor: (resp, start, size) => {
        ...
        if (resp.hasOwnProperty('data')) {
          ...
          if (resp.error) {
            ...
            throw new Error(
              "Unknown error with graphQl result in resultPorcessor for entity type 'cmsHierarchy'"
            );
          }
        }
      }
