...
export const quickSearchByQuery = async ({
  ...
  return new Promise((resolve, reject) => {
    ...
    if (
      rootStore.state.config.usePriceTiers &&
      entityType === 'product' &&
      rootStore.state.user.groupId
    ) {
    ...
    if (
      rootStore.state.config.usePriceTiers &&
      rootStore.state.user.groupToken
    ) {
    ...
    searchAdapter
      ...
      .then(resp => {
        ...
        const res = searchAdapter.entities[Request.type].resultPorcessor(
          resp,
          start,
          size
        );
        ...
        if (res) {
          ...
          cache
            .setItem(
              ...
              res,
              null,
              rootStore.state.config.elasticsearch
                .disableLocalStorageQueriesCache
            )
            .catch(err => {
