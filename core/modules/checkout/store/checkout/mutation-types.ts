...
export const CHECKOUT_REPLACE_PAYMENT_METHODS = SN_CHECKOUT + '/REPLACE_PAYMENT_METHODS'
export const CHECKOUT_ADD_SHIPPING_METHOD = SN_CHECKOUT + '/ADD_SHIPPING_METHOD'
export const CHECKOUT_REPLACE_SHIPPING_METHODS = SN_CHECKOUT + '/REPLACE_SHIPPING_METHODS'
