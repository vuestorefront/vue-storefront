...
export const CHECKOUT_UPDATE_BRANDS_DETAILS = SN_CHECKOUT + '/UPDATE_BRANDS_DETAILS'
export const CHECKOUT_UPDATE_SELECTED_SHIPPING_METHOD = SN_CHECKOUT + '/UPDATE_SELECTED_SHIPPING_METHOD'
