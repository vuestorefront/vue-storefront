...
export const CATEGORY_SET_CURRENT_PAGE_PRODUCTS = `${SN_CATEGORY}/CATEGORY_SET_CURRENT_PAGE_PRODUCTS`
export const CATEGORY_RESET_CURRENT_PAGE_PRODUCTS = `${SN_CATEGORY}/CATEGORY_RESET_CURRENT_PAGE_PRODUCTS`
