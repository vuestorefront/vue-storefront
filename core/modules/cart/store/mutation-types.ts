...
export const CART_CALC_HASH = SN_CART + '/CALC_HASH'
export const CART_SAVE_HASH = SN_CART + '/SAVE_HASH'
export const CART_MARK_SYNC = SN_CART + '/MARK_SYNC'
export const CART_MARK_TOTALS_SYNC = SN_CART + '/MARK_TOTALS_SYNC'
