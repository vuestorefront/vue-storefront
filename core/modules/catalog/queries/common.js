...
export function prepareQuery({
  ...
  if (filters.length === 0 && queryConfig !== '') {
    ...
    if (
      store.state.config.hasOwnProperty('query') &&
      store.state.config.query.hasOwnProperty(queryConfig) &&
      store.state.config.query[queryConfig].hasOwnProperty('filter')
    ) {
  ...
  if (queryText === '') {
    ...
    if (
      store.state.config.hasOwnProperty('query') &&
      store.state.config.query.hasOwnProperty(queryConfig) &&
      store.state.config.query[queryConfig].hasOwnProperty('searchText')
    ) {
