...
export const CATALOG_SET_PRODUCT_ORIGINAL =
  SN_PRODUCT + '/SET_PRODUCT_ORIGINAL';
...
export const CATALOG_ADD_CUSTOM_OPTION_VALIDATOR =
  SN_PRODUCT + '/ADD_CUSTOM_OPTION_VALIDATOR';
