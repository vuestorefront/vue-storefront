...
export const SET_PRODUCT_DISCOUNTED_PRICE = SN_PRODUCT + '/SET_PRODUCT_DISCOUNTED_PRICE'
export const SET_EXCHANGE_RATE = SN_PRODUCT + SN_PRODUCT + '/SET_EXCHANGE_RATE'
// remove later
