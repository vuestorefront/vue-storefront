...
export const CATEGORY_UPD_SIDEBAR_SELECTED_CATEGORY = SN_CATEGORY + '/UPD_SIDEBAR_SELECTED_CATEGORY'
export const CATEGORY_REMOVE_SIDEBAR_SELECTED_CATEGORY = SN_CATEGORY + '/REMOVE_SIDEBAR_SELECTED_CATEGORY'
