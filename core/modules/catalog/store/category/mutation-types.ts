...
export const CATEGORY_UPD_CURRENT_CATEGORY =
  SN_CATEGORY + '/UPD_CURRENT_CATEGORY';
export const CATEGORY_UPD_CURRENT_CATEGORY_PATH =
  SN_CATEGORY + '/UPD_CURRENT_CATEGORY_PATH';
export const CATEGORY_UPD_SEARCH_PRODUCT_QUERY =
  SN_CATEGORY + '/UPD_SEARCH_PRODUCT_QUERY';
