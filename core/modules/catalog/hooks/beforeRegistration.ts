...
export function beforeRegistration({ Vue, config, store, isServer }) {
  ...
  Vue.prototype.$db.categoriesCollection = new UniversalStorage(
  ...
  Vue.prototype.$db.attributesCollection = new UniversalStorage(
    localForage.createInstance({
      name: dbNamePrefix + 'shop',
  ...
  Vue.prototype.$db.elasticCacheCollection = new UniversalStorage(
    localForage.createInstance({
      name: dbNamePrefix + 'shop',
  ...
  Vue.prototype.$db.productsCollection = new UniversalStorage(
    localForage.createInstance({
      name: dbNamePrefix + 'shop',
      storeName: 'products',
