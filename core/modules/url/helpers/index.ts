...
import { localizedDispatcherRoute, localizedRoute as localizedRouter, currentStoreView, removeStoreCodeFromRoute } from '@vue-storefront/core/lib/multistore'
import { RouteConfig } from 'vue-router/types/router';
import { RouterManager } from '@vue-storefront/core/lib/router-manager'
import { Category } from '@vue-storefront/core/modules/catalog-next/types/Category'
import { Logger } from '@vue-storefront/core/lib/logger'
import { LocalizedRoute, StoreView } from '@vue-storefront/core/lib/types'
...
export function formatProductLink (
  ...
  if (config.seo.useUrlDispatcher && product.url_path) {
    ...
    return localizedRouter(routeData, storeCode)
  }
}
