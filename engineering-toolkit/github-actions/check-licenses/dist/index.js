...
var license_checker_rseidelsohn_1 = __importDefault(__nccwpck_require__(9989));
var licenses_1 = __nccwpck_require__(3560);
var npmPackages_1 = __nccwpck_require__(5558);
function run() {
        ...
        return __generator(this, function (_a) {
            ...
            try {
                ...
                license_checker_rseidelsohn_1.default.init({
                    start: projectPath,
                    summary: true,
                    excludePackagesStartingWith: npmPackages_1.EXCLUDE_NPM_PACKAGES.join(";"),
                    onlyAllow: licenses_1.ALLOWED_LICENSES.join(";"),
