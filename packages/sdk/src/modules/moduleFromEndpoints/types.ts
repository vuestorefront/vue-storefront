...
/**
 * Type helper to validate the endpoints and enforce the constraint.
 * It will break the build if the endpoints are not valid.
 *
 * @example
 * ```ts
 * type Endpoints = {
 ...
 *
 * // It will break the build if the endpoints are not valid.
 * type ValidateEndpoints = EnforceEndpointsConstraint<Endpoints>;
 * ```
 */
