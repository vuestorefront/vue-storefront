...
export const getMasterByKey: typeof BapiClient.prototype.masters.getByKey = (...args) => apiClient.masters.getByKey(...args);
export const getMastersByQuery: typeof BapiClient.prototype.masters.query = (...args) => apiClient.masters.query(...args);
