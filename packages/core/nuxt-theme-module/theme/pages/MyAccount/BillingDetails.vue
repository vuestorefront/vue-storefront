<template>
  <transition name="fade">
    ...
    >
      <SfTab
        v-e2e="'billing-details-tab_change'"
    ...
    <SfTabs
      ...
      key="address-list"
      class="tab-orphan">
      <SfTab v-e2e="'billing-details-tab_details'" title="Billing details">
        <p class="message">
        ...
        <transition-group tag="div" name="fade" class="billing-list">
          <div
            ...
            <div class="billing__actions">
              <SfIcon
                v-e2e="'billing-details-icon_delete'"
                icon="cross"
                color="gray"
                size="14px"
                role="button"
              ...
              />
              <SfButton
                v-e2e="'billing-details-btn_change'"
                @click="changeAddress(address)">
                {{ $t('Change') }}
              </SfButton>

              <SfButton
                v-e2e="'billing-details-btn_delete'"
