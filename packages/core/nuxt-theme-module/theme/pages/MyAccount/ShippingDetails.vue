<template>
  <transition name="fade">
    ...
    >
      <SfTab
        v-e2e="'shipping-details-tab_change'"
    ...
    <SfTabs
      ...
      key="address-list"
      class="tab-orphan">
      <SfTab v-e2e="'shipping-details-tab_details'" title="Shipping details">
        <p class="message">
        ...
        <transition-group tag="div" name="fade" class="shipping-list">
          <div
            ...
            <div class="shipping__actions">
              <SfIcon
                v-e2e="'shipping-details-icon_delete'"
                icon="cross"
                color="gray"
                size="14px"
                role="button"
              ...
              />
              <SfButton
                v-e2e="'shipping-details-btn_change'"
                @click="changeAddress(address)">
                {{ $t('Change') }}
              </SfButton>

              <SfButton
                v-e2e="'shipping-details-btn_delete'"
        ...
        <SfButton
          v-e2e="'shipping-details-btn_add'"
          class="action-button"
          @click="changeAddress()">
          {{ $t('Add new address') }}
        </SfButton>
