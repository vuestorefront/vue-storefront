...
export default {
  ...
  'Product description': 'Das Karissa V-Neck Tee hat eine halb taillierte Form schmeichelhaft für jede Figur. Sie können mit Selbstbewusstsein Fitnessstudio gehen, während es Kurven kaschiert und häufige "Problembereiche" verbirgt. Finden Sie atemberaubende Cocktail- und Abendkleider für Frauen.',
  'Brand': 'Marke',
  ...
  'Empty': 'Sieht so aus, als hätten Sie dem Warenkorb noch keine Artikel hinzugefügt. Beginnen Sie mit dem Einkaufen, um ihn zu füllen.',
  ...
  'Enjoy your free account': 'Genießen Sie diese Vergünstigungen mit ihrem kostenlosen Account!',
  'Continue to payment': 'Weiter zur Zahlung',
  'Order No.': 'Bestellnummer',
  'Successful placed order': 'Sie haben die Bestellung erfolgreich aufgegeben. Sie können den Status Ihrer Bestellung über unseren Lieferstatus einsehen. Sie erhalten eine Bestätigungs-E-Mail mit Details Ihrer Bestellung und einem Link zum Verfolgen der Bestellung.',
  'Info after order': 'Sie können sich mit Ihrer E-Mail und gewählten Passwort in Ihrem Konto anmelden. Überprüfen Sie in Ihrem Konto Ihre Profildaten, Transaktionsverlauf, Abonnement für Newsletter bearbeiten.',
  ...
  'Color': 'Farbe',
  'Contact details updated': 'Halten Sie Ihre Adresse und Kontaktdaten auf dem neuesten Stand.',
