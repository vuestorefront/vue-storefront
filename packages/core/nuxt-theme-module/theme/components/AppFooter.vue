  ...
  <SfFooter :column="4" multiple class="footer">
    <SfFooterColumn :title="$t('About us')">
      <SfList>
        <SfListItem
          ...
          >
          <SfMenuItem
            :v-e2e="`app-foter-url_about-us_${item.split(' ').join('-').toLowerCase()}`"
            :label="$t(item)"
          />
        </SfListItem>
      </SfList>
    ...
    <SfFooterColumn :title="$t('Departments')">
      <SfList>
        ...
        >
          <SfMenuItem
            :v-e2e="`app-foter-url_departments_${item.split(' ').join('-').toLowerCase()}`"
            :label="$t(item)"
          />
        </SfListItem>
      </SfList>
    ...
    <SfFooterColumn :title="$t('Help')">
      <SfList>
        ...
        >
          <SfMenuItem
            :v-e2e="`app-foter-url_help_${item.split(' ').join('-').toLowerCase()}`"
            :label="$t(item)"
          />
        </SfListItem>
      </SfList>
    ...
    <SfFooterColumn :title="$t('Payment & Delivery')">
      <SfList>
        ...
        >
          <SfMenuItem
            :v-e2e="`app-foter-url_payment_${item.split(' ').join('-').toLowerCase()}`"
            :label="$t(item)"
          />
        </SfListItem>
      </SfList>
