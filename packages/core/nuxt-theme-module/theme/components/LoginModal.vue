  ...
  >
    ...
    <transition name="sf-fade" mode="out-in">
      <div v-if="isLogin">
        <ValidationObserver v-slot="{ handleSubmit }" key="log-in">
          <form class="form" @submit.prevent="handleSubmit(handleLogin)">
            ...
            <SfCheckbox
              v-e2e="'login-checkbox-remember-me'"
              v-model="rememberMe"
              name="remember-me"
              label="Remember me"
              class="form__element checkbox"
            />
            <SfButton v-e2e="'login-btn_submit'"
              type="submit"
        ...
        <div class="action">
          <SfButton v-e2e="'login-btn_forgot-password'" class="sf-button--text">
            {{ $t('Forgotten password?') }}
          </SfButton>
        </div>
        <div class="bottom">
          <p class="bottom__paragraph">{{ $t('No account') }}</p>
          <SfButton v-e2e="'login-btn_sign-up'" class="sf-button--text" @click="isLogin = false">
            {{ $t('Register today') }}
          </SfButton>
        </div>
      </div>
      <div v-else class="form">
        ...
        <div class="action">
          {{ $t('or') }}
          <SfButton v-e2e="'login-btn_login-into-account'" class="sf-button--text" @click="isLogin = true">
