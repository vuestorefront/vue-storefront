    ...
    sidebar: {
      ...
      '/commercetools/': [
        {
          ...
          children: [
            ...
            [
              'https://www.notion.so/vuestorefront/6017d5a553904d0bbdcdf0f37d388c2b?v=a618b57067f34e68944145ade66da3a3',
              'Feature list'
            ],
        ...
        },
        {
          ...
          children: [
            ...
            [
              '/commercetools/enterprise/use-user-shipping',
              'Shipping addresses'
            ],
      ...
      '/': [
        ...
        },
        {
          ...
          children: [
            [
              '/composables/rules-and-best-practices',
        ...
        },
        {
          ...
          children: [
            ...
            ['/aboutyou/', 'About you'],
            [
              'https://shopware-pwa-docs.netlify.com/#introduction-to-shopware-pwa',
              'Shopware'
            ],
