...
import { customerSignMeUp, customerSignMeIn, customerSignOut, getMe } from '@vue-storefront/commercetools-api'
...
describe('[commercetools-composables] useUser', () => {
  ...
  it('login customer and log out', async () => {
    ...
    wrapper.vm.$data.login({ email: 'john@doe.com', password: '123' })
