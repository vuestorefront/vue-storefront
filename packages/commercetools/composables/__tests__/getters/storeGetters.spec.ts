...
function makeStore (storeId, storeName, storeKey, channelID = null, channelName = null) {
  return {
...
const distributionChannels = (id) => ([
  { id: 'd1', name: 'distribution channel 1', key: `key-${id}`},
  { id: 'd2', name: 'distribution channel 2', key: `key-${id}`},
  { id: 'd3', name: 'distribution channel 3', key: `key-${id}` }
]);

const supplyChannels = (id) => ([
  { id: 's1', name: 'supply channel 1', key: `key-${id}` },
  { id: 's2', name: 'supply channel 2', key: `key-${id}` },
  { id: 's3', name: 'supply channel 3', key: `key-${id}` }
]);

const results = [
  { id: '1', name: 'store-1', key: 'key-1', distributionChannels: distributionChannels('1'), supplyChannels: supplyChannels('1') },
  { id: '2', name: 'store-2', key: 'key-2', distributionChannels: [], supplyChannels: supplyChannels('2') },
  { id: '3', name: 'store-3', key: 'key-3', distributionChannels: distributionChannels('3'), supplyChannels: [] },
  { id: '4', name: 'store-4', key: 'key-4', distributionChannels: [], supplyChannels: [] }
];
