  ...
  <SfTabs :open-tab="1">
    <SfTab title="My orders">
      ...
      <div v-else>
        ...
        <div v-if="count === 0" class="no-orders">
        ...
        <div v-else>
          ...
          <div class="pagination" v-if="count < total">
            <SfArrow
              aria-label="prev"
            ...
            <div class="pagination-count">
              {{count > 1 ? `${offset + 1} - ` : ''}}{{offset + count}} <strong>of</strong> {{total}}
            </div>
            <SfArrow
              aria-label="next"
...
export default {
  ...
  setup() {
    ...
    return {
      ...
      total: computed(() => orders.value?.total ?? 0),
      offset: computed(() => orders.value?.offset ?? 0),
      count: computed(() => orders.value?.count ?? 0),
      goNext,
      goPrev,
      tableHeaders,
      getStatusTextClass,
