  ...
  <div>
    ...
    <div class="form">
      ...
      <div class="form__action">
        ...
        <SfButton data-cy="checkout-continue-button" class="form__action-button" @click="$emit('nextStep')" v-if="canContinueToReview">
          Review my order
        </SfButton>
        <SfButton data-cy="checkout-continue-button" class="form__action-button" @click="saveBillingDetails" v-else>
