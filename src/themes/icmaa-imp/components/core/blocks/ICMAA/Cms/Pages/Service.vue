<template>
  <div id="cms-page" class="t-container t-p-4" v-if="page">
    <h1 v-html="content.quickHelp.headline" />
    <ul>
    ...
    <div class="t-flex t-flex-wrap t--mx-2">
      <div v-for="member in content.serviceTeam.team" :key="member.name" class="t-w-full sm:t-w-1/2 md:t-w-1/3 lg:t-w-1/4 t-px-2 t-pb-4">
        <div class="t-relative">
          <div v-html="member.name" class="t-absolute t-top-0 t-left-0 t-p-3 sm:t-p-4 t-font-serif t-text-gray-800 t-text-2xl" />
