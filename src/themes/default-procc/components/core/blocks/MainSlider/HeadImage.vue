<template>
  <section class="head-image w-100 bg-cl-th-accent cl-white">
    <!--        // Changes Vinod-->
    <div class="container w-100 h-100" v-lazy:background-image="currentImage.image" v-if="currentImage">
      <div class="head-image-content">
        <h1 class="title" :style="{color: currentImage.title_color}" data-testid="mainSliderTitle">
          {{ currentImage.title }}
        </h1>
        <p
