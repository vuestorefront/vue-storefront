...
let routes = [
  ...
  { name: 'warranty', path: '/warranty', component: Static, props: {page: 'lorem', title: 'Warranty Policy'}, meta: {page: 'warranty'} },
  { name: 'shipping', path: '/shipping', component: Static, props: {page: 'lorem', title: 'Shipping Policy'}, meta: {page: 'shipping'} },
  { name: 'order-from-catalog', path: '/order-from-catalog', component: Static, props: {page: 'lorem', title: 'Order from catalog'} },
  { name: 'contact', path: '/contact', component: Static, props: {page: 'contact', title: 'Contact'}, meta: {page: 'contact'} },
