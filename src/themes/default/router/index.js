...
const CmsBlockDemoPageSsr = () =>
  import(
    /* webpackChunkName: "vsf-cms-demo" */ 'theme/pages/CmsBlockDemoPageSsr.vue'
  );
const Checkout = () =>
...
const CustomCmsPage = () =>
  import(
    /* webpackChunkName: "vsf-custom-cms" */ 'theme/pages/CustomCmsPage.vue'
  );
const CmsData = () =>
  import(
    /* webpackChunkName: "vsf-data" */ 'src/modules/magento-2-cms/components/CmsData'
  );
...
let routes = [
  ...
  {
    name: 'cms-block-demo-page-ssr',
    path: '/cms-block-demo-page-ssr',
    component: CmsBlockDemoPageSsr
  },
  {
    name: 'cms-page-sync',
    path: '/cms-page-sync',
