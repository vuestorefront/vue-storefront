    ...
    <div class="row">
      <div class="col-xs-12 h4 serif">
        <ul class="p0 m0 relative sidebar-menu__list" :style="mainListStyles">
          ...
          <li @click="closeMenu">
            <router-link class="px25 py20 brdr-bottom brdr-c-alto c-black no-underline" to="/magazine" exact>
              Magazine
            </router-link>
          </li>
          <li @click="closeMenu">
            <router-link class="px25 py20 brdr-bottom brdr-c-alto c-black no-underline" to="/sale" exact>
              Sale
            </router-link>
          </li>
          <li @click="closeMenu">
            <router-link class="px25 py20 brdr-bottom brdr-c-alto c-black no-underline" to="/order-tracking" exact>
              Track my order
            </router-link>
          </li>
          <li @click="closeMenu" class="brdr-bottom brdr-c-alto flex">
            <router-link v-if="currentUser" class="px25 py20 c-black no-underline col-xs" to="/my-account" exact>
              My account
            </router-link>
