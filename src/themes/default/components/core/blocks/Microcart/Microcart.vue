<template>
  <div class="microcart bg-white c-black" :class="{ active: isOpen }">
    ...
    <div v-if="!items.length" class="ml30" @click="closeMicrocart">Don't hesitate and <router-link to="/">browse our catalog</router-link> to find something beatufiul for You!</div>
    <ul class="products">
