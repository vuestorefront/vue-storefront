      ...
      <div class="container">
        <div class="row center-xs">
          ...
          <div class="row social col-lg-5 col-md-4 mt30 center-xs end-xs">
            <a class="social-icon ml20 brdr-circle no-underline" href="https://www.facebook.com/">
            ...
            <a class="social-icon ml20 brdr-circle no-underline" href="https://www.instagram.com">
            ...
            <a class="social-icon ml20 brdr-circle no-underline" href="https://www.pinterest.com">
            ...
            <a class="social-icon ml20 brdr-circle no-underline" href="https://www.youtube.com">
        ...
        <div class="hidden-xs col-sm-9 end-xs">
          <ul class="links">
            <li class="inline-flex">
              <router-link class="c-lightgray-secondary mr15 underline" to="/legal" exact>Legal notice</router-link>
            </li>
            <li class="inline-flex">
