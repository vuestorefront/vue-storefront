    ...
    <div class="footer-links pt30 pb60 px40 bg-lightgray" v-if="!isCheckout">
      <div class="container">
        <div class="row center-xs">
          ...
          <div class="row social col-lg-5 col-md-4 col-xs-12 mt30 center-xs end-xs">
            <a class="social-icon no-underline" href="https://www.facebook.com/">
            ...
            <a class="social-icon no-underline" href="https://www.instagram.com">
            ...
            <a class="social-icon no-underline" href="https://www.pinterest.com">
            ...
            <a class="social-icon no-underline" href="https://www.youtube.com">
