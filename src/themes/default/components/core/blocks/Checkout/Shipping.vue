<template>
  <div class="shipping">
    ...
    <div class="row">
      ...
      <div class="col-md-6 mb25">
        <input type="text" name="country" placeholder="Zip-code" v-model="shipping.zipCode" v-on:change="sendDataToCheckout">
      ...
      <div class="col-md-12 mb25">
        <input type="text" name="phone number" placeholder="Phone Number" v-model="shipping.phoneNumber" v-on:change="sendDataToCheckout">
      </div>
      <div class="col-md-12">
