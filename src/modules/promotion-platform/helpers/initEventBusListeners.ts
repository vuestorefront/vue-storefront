...
import { getBundleCartItemDiscountPrice, getBundleDefaultProductDiscountPrice } from './bundle-product-discount-price';
...
export default function initEventBusListeners (store: Store<RootState>, app: Vue) {
  ...
  EventBus.$on(UPDATE_DEFAULT_PRODUCT_DISCOUNT_PRICE_DATA_EVENT_ID, (productPriceData: UpdateProductDiscountPriceEventData) => {
    let discountedPrice;
