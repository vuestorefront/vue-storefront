...
You might use CDN not only to serve dist & assets directory but also SSR Output. In this case, you would want to dynamically purge cache in Cloudflare when it is being purged in Varnish. 
