...
Translations are provided in `core/i18n/resource/i18n/en-US.csv` file and can be extended / overridden in `src/themes/[your-theme]/resource/i18n/en-US.csv` accordingly.
...
when you create the `en-US.csv` file within your `src/themes/[your-theme]/resource/i18n/` folder and override some messages like:
