...
The syntax is the same as the one used in the .gitignore file. Ignore rules of a store merge with the ignore rules of its parents, where the ignore rules of the parent store are applied first.
