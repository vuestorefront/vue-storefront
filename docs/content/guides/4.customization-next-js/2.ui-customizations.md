...
This is a very simple task but should help you get familiar with the Alokai storefront structure.
...
Anyway, the logo is located in `storefront-unified-nextjs/components/ui/NavbarTop/NavbarTop.tsx` component.

🛠️ Open it and replace `SfIconAlokaiFull` with your custom image. I used [LogoIpsum](https://logoipsum.com/) to find a sample logo.
...
🛠️ Locate where the `NavbarTop` component is used and remove the `filled` property. This will make the navbar transparent.
...
so I encourage you to try doing it yourself and checking back here when you're done.
...
🚀 Before jumping to the solution I encourage you to think about how would you do this yourself. Investigate the application and
