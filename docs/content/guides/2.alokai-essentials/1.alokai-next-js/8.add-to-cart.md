...
::grid{:columns="3"}
#section-1
:card{to="/guides/alokai-essentials/alokai-next-js/udl" title="Next: Unified Data Layer" description="Learn how to install, configure and use Unified Data Layer" icon="tabler:hexagon-8-filled"}
::
