...
::grid{:columns="3"}
#section-1
:card{to="/guides/alokai-essentials/alokai-next-js/add-to-cart" title="Next: Add product to Cart" description="Learn how to use Alokai Connect to add product to cart" icon="tabler:number-7-small"}
::
