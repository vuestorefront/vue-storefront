...
::grid{:columns="3"}
#section-1
:card{to="/guides/alokai-essentials/alokai-next-js/connecting-pdp" title="Next: Connecting Product Details Page with SAP Commerce Cloud" description="Learn how to use real data with Storefront UI" icon="tabler:number-6-small"}
::
