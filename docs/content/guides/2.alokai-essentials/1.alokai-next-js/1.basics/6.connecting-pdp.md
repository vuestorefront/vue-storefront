...
::grid{:columns="3"}
#section-1
:card{to="/guides/alokai-essentials/alokai-next-js/basics/add-to-cart" title="Add product to Cart" description="Learn how to use Alokai Connect to add product to cart" icon="tabler:number-7-small"}
::
