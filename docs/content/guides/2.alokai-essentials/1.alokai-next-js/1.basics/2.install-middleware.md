...
::grid{:columns="3"}
#section-1
:card{to="/guides/alokai-essentials/alokai-next-js/basics/install-sdk" title="Install and Configure Alokai SDK" description="Let's install and configure the Alokai SDK in the Next.js application" icon="tabler:number-3-small"}
::