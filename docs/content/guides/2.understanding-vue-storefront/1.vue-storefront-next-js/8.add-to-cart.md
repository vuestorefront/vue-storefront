...
In the next guide, we will learn about [Unified Data Layer](https://docs.vuestorefront.io/storefront/unified-data-layer), how to install it, configure and how to use it in Vue Storefront Next.js application. See you there!

::grid{:columns="3"}
#section-1
:card{to="/guides/understanding-vue-storefront/vue-storefront-next-js/udl" title="Unified Data Layer" description="Learn how to install, configure and use Unified Data Layer" icon="tabler:number-8-small"}
::
