...
::grid{:columns="3"}
#section-1
:card{to="/guides/understanding-vue-storefront/vue-storefront-next-js/basics/install-sdk" title="Install and Configure Vue Storefront SDK" description="Let's install and configure the Vue Storefront SDK in the Next.js application" icon="tabler:number-3-small"}
::