...
::grid{:columns="3"}
#section-1
:card{to="/guides/understanding-vue-storefront/vue-storefront-next-js/basics/connecting-pdp" title="Connecting Product Details Page with SAP Commerce Cloud" description="Learn how to use real data with Storefront UI" icon="tabler:number-6-small"}
::
