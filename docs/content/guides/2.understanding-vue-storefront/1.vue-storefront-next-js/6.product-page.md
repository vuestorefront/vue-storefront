...
::info
Already familiar with **Storefront UI**? You can skip this section and jump to [Connecting Product Details Page with SAP Commerce Cloud](./7.connecting-pdp). You can find the code for this guide in the [nextjs-starter/product-page branch](https://github.com/vuestorefront-community/nextjs-starter/tree/product-page)
::
...
![Storefront UI Button](./images/sfui-1.png)
...
![Product Details Page](./images/sfui-2.png)
...
![Product Details Page with Styles](./images/sfui-3.png)
...
::grid{:columns="3"}
#section-1
:card{to="/guides/vue-storefront-next-js/connecting-pdp" title="Connecting Product Details Page with SAP Commerce Cloud" description="Learn how to use real data with Storefront UI" icon="tabler:number-6-small"}
::
