...
Deployment cannot be triggered without a valid region configuration. Ensure you select a region that matches a region selected for your project in the Alokai Console.
::
