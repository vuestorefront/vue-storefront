...
For example, if you want to customize a product card component, you would create the same file path in your store's directory as it exists in the base application:

```bash
# Original component in the base Next.js application (apps/storefront-unified-nextjs)
...
Alokai provides several base applications that serve as the foundation for all stores:

```bash
apps/storefront-unified-nextjs/  # Base Next.js Storefront application
apps/storefront-unified-nuxt/    # Base Nuxt Storefront application
apps/storefront-middleware/      # Base Middleware application
apps/playwright/                 # Base E2E tests
```
