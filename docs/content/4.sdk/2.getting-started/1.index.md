...
If you're using the App Router, you can do it in two steps:
...
Each of the hooks provide a way to read and write to the state. The syntax is similar to the `useState` hook from React.
