...
::tabs{:titles='["Next", "Nuxt", "Framework Agnostic"]' class="mt-8"}

#tab-1

## Installation

In order to use the SDK, you'll need to install the SDK package. Enter the command below in the root of your project to install Next.js SDK module:
...
In order to use the SDK, you'll need to install and configure the Vue Storefront SDK Nuxt module.
...
Once you have registered the SDK in your application, you can start using it. Here's an example of how you can use the SAP Commerce Cloud and Contentful modules in your application:
...
2. Import the `initSDK` and `buildModule` from the SDK, along with any imports needed to add additional modules.
