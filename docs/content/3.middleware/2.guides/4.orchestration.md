...
::steps
#step-1 
### Extend the integration with new endpoint: 
Create a new endpoint that will act as the main entry point for the grouped requests.

#step-2
### Group Server Requests: 
 Within this endpoint, use the `getApiClient` method to retrieve and interact with the required integrations.

#step-3 
### Aggregate Data: 
Once data from all required integrations is retrieved, aggregate and format it as needed.

#step-4
 ### Return Unified Response: 
 Send a consolidated response back to the frontend.
::
