...
- Removed redundant request header `Content-Type`, `mode` and `Accept` while calling TaskQueue.execute/queue, added these request header in task getPayload method.
