...
### Changed / Improved
- Changed the way to access the configuration. Currently the `rootStore.state.config` is deprecated. Please do use the `@vue-storefront/core/lib/config-manager.ts` > `config` instead - @pkarw (#2649)
