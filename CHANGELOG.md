...
- Replace `sw-precache` & `register-service-worker` with latest `workbox` library from Google - @cewald ([#2492](https://github.com/vuestorefront/vue-storefront/issues/2492))
