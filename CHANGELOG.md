...
- Improved: the code to remove the page key from the query before applying a filter - @ymaheshwari1 ([#561](https://github.com/vuestorefront/vsf-capybara/issues/561))
